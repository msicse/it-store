                        ...
                        <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                            ...
                            <tbody>
                                ...
                                <form action="{{ route('admin.transections.update', $data->id) }}" method="post" >
                                    ...
                                    <td>{{ $data->quantity }}</td>
                                    <td>
                                        <a href="{{ route('admin.transections.show', $data->id) }}" class="btn btn-info waves-effect " style="margin-top: 5px;" >
                                        ...
                                        <a href="{{ route('admin.transections.ack', $data->id) }}" target="blank" title="Print Acknowledgement" class="btn btn-primary waves-effect "  style="margin-top: 5px;">
                                            <i class="material-icons">print</i>
                                        </a>
